...
export default async function handler(req, res) {
    ...
    try {
        ...
        //const resultsCard = await axios(`https://www.veikkaus.fi/api/toto-info/v1/card/${gameCarId}/races`)
        //console.log(gameCarId)
        const resultsAll = await axios(`https://www.veikkaus.fi/api/toto-info/v1/card/${gameCarId}/results`)
        console.log(resultsAll.data['collection'])

        //console.log(resultsCard.data['collection'])
